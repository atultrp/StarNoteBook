        ...
        <>
            {
                ...
                <div className="container">
                    ...
                    <p className="mx-5 text-center lead">Star Notebook is the best word processing app for all your works, from taking down quick notes to writing your books, eBooks, organizing your documents and daily tasks.</p>
                    <div className="my-5 row g-3">
                        <div className="card my-4 col-md-3 mx-auto " style={{width: "18rem"}}>
                            <img src={Background4} className="card-img-top" alt="..."/>
                        ...
                        <div className="card my-4 col-md-3 mx-auto " style={{width: "18rem"}}>
                            <img src={Background3} className="card-img-top" alt="..."/>
                            <div className="card-body">
                        ...
                        <div className="card my-4 col-md-3 mx-auto " style={{width: "18rem"}}>
                            <img src={Background1} className="card-img-top" alt="..."/>
                            <div className="card-body">
